...
const createPollGetController = (req, res) => {
    res.render('createPoll');
}

const createPollPostController = async (req, res) => {
    try {
...
module.exports  = { createPollGetController, createPollPostController, postCommentController, getPollController }